...
}, jf = (e, t) => e.toLocaleLowerCase().includes("https://pub.highlight.io") || e.toLocaleLowerCase().includes("pub.highlight.io") || e.toLocaleLowerCase().includes("otel.highlight.io") || t.some((r) => e.toLocaleLowerCase().includes(r)), bt = (e, t, r) => !jf(e, t) || Wr(e, r != null ? r : [], []), Wr = (e, t, r) => {
  var o;
...
const yt = "highlight.record", Kp = (e) => {
  ...
  const t = e.backendUrl || "https://pub.highlight.io", r = [
...
class Qr {
  ...
  static setupNetworkListener(t, r) {
    ...
    const n = (r == null ? void 0 : r.backendUrl) || "https://pub.highlight.io", i = r.otlpEndpoint || "https://otel.highlight.io";
...
const w = {
  ...
  init: (e, t) => {
    ...
    try {
      ...
      Mr = !0, Cr(), xr(), import("./index-CZOd3_dt.js").then((v) => G(void 0, [v], function* ({ Highlight: h, setupBrowserTracing: E, getTracer: p }) {
        var T, S, b;
        E({
...
//# sourceMappingURL=index-B1VzWttN.js.map
