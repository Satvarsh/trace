 ...
 */
export declare const XHRListener: (callback: NetworkListenerCallback, highlightEndpoints: string[], tracingOrigins: boolean | (string | RegExp)[], urlBlocklist: string[], bodyKeysToRedact: string[], bodyKeysToRecord: string[] | undefined) => () => void;
